...
| 05 | [Frontend Dashboard — Angular](05-frontend-dashboard/README.md) | Complete | Dark-themed Angular Material SPA with Chart.js line charts, Material tables, and a thermostat command form |
