...
|---|---------|--------|-------------|
| 01 | [Messaging Library (RedisBus)](01-messaging-library/README.md) | Accepted | Radically-simple common library for telemetry, events, query/response, and request/response over Redis Pub/Sub |
