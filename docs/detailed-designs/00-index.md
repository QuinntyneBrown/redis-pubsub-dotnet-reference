...
| 03 | [Command Pattern Extension](03-command-pattern/README.md) | Accepted | Adds `ICommand<TResponse>` (channel `cmd.*`) as a fifth pattern alongside telemetry / event / query / request |
